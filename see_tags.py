...
# Form implementation generated from reading ui file 'C:/Users/xiaomi/Documents/GitHub/practice1/qt/see_tags.ui'
#
...
"font: 10pt \"MS Shell Dlg 2\";")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:16pt; font-weight:600;\">HTML-теги веб-сайта</span></p></body></html>"))
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt;\">HTML-теги, показанные на данной странице, <br/>используются в HTML файлах верстки <br/>вашего сайта.<br/><br/>!!! Ни в коем случае не удаляйте их <br/>описания в CSS файлах сайта, <br/>это может нарушить работу сайта!!!</span></p></body></html>"))
        self.pushButton_5.setText(_translate("MainWindow", "Назад"))
        self.pushButton_6.setText(_translate("MainWindow", "Посмотреть список тегов"))
